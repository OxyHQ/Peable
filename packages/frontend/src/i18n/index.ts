...
const translations: Record<TranslatedLanguage, Record<string, string>> = {
  en: {
    ...
    "readOnly.notice": "You're in a browser: you can receive and see your payments. To send, open Peable on your phone.",
    "readOnly.history.empty": "No payments yet. Share your code from Receive and they'll show up here.",
    ...
    "settings.oxyAccount": "Oxy account",
  ...
  es: {
    ...
    "readOnly.notice": "Estás en el navegador: puedes recibir y ver tus pagos. Para enviar, abre Peable en el móvil.",
    "readOnly.history.empty": "Todavía no hay pagos. Comparte tu código desde Recibir y aparecerán aquí.",
    ...
    "settings.oxyAccount": "Cuenta Oxy",
